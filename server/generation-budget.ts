...
export class GenerationBudget {
  ...
  private expire(){this.controller.abort(new Error(`Creation exceeded its ${this.limits.timeoutMs/1000}-second work deadline. Any published draft is still available.`));}
