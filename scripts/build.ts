...
await build({entryPoints:['server/index.ts','server/runtime-child.ts','server/compile-child.ts'],bundle:true,platform:'node',format:'esm',packages:'external',outdir:'dist/server',sourcemap:true});
